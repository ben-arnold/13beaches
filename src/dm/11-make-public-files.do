...
log using "~/13beaches/src/dm/11-make-public-files.log", text replace

*----------------------------------------
* 11-make-public-files.do
* ben arnold
*
* subset files to only the variables 
* used in the analysis
*
* blind dates to make it difficult to
* identify actual day of the year
*
*----------------------------------------
...
*
* output files:
*	13beaches-wq-samples-public.dta
*	13beaches-wq-public.dta
*	13beaches-epi.dta
*	13beaches-analysis-public.dta / .csv
...
keep beach beachcode hhid indid teledate intdate /*
*/ gibase utibase vomitbase sorebase earbase eyebase rashbase /*
*/ gichron asth allergy skinchron /*
*/ anycontact bodycontact swallwater /*
*/ diarrhea* nausea* stomach* vomiting* rash* eyeinfection* earache* fever* urinarytractinfection* cough* sorethroat* runnynose* cold* stopdaily_* /*
*/ age sex gicontact_base berm groundwater /*
*/ race anim_any rawfood


* recode dates
* pick day 1 as march 30, 1978
gen newteledate = teledate - mdy(3,29,1978)
gen newintedate = intdate - mdy(3,29,1978)
