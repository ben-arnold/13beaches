...
plot(1,1,type="n",
	...
	segments(x0=rep(0,3),x1=rep(0.5,3),y0=rep(0,3),y1=diar.noswim.par100/2,lty=c(2,3,4),lwd=2,col=alpha(cols,1))
...
plot(1,1,type="n",
	...
	segments(x0=rep(0,3),x1=rep(0.5,3),y0=rep(0,3),y1=gi.noswim.par100/2,lty=c(2,3,4),lwd=2,col=alpha(cols,1))
...
pdf("~/dropbox/13beaches/aim2-results/figs/aim2-PAR-entero1600noswim-AJPH.pdf",width=12,height=5)
lo <- layout(mat=matrix(1:2,nrow=1,ncol=2))
op <- par(mar=c(4,3,4,5)+0.1,cex.axis=1.2)
# cols <- brewer.pal(5,"Dark2")
# cbPalette <- c("#000000","#999999", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7")
